...
if not st.session_state['logged_in']:
    ...
    with col2:
        # MAIN LOGIN PAGE DISCORD BUTTON
        st.link_button("🎧 JOIN DISCORD LIVE WAR ROOM (Voice & Chat)", DISCORD_LINK, use_container_width=True)
...
# MAIN DASHBOARD DISCORD BUTTON (Hamesha Top Par Dikhega)
