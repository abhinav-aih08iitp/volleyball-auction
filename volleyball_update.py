...
# Auto-refresh every 1.5 seconds for real-time bidding sync
...
# --- 4. BACKGROUND & CSS (PREMIUM DARK UI) ---
...
if st.session_state['user_role'] == "Masterji":
    with st.expander("🛠️ MASTERJI COMMAND CENTER", expanded=False):
        ...
        if avail:
            call = st.selectbox("Call Specific Player", avail)
